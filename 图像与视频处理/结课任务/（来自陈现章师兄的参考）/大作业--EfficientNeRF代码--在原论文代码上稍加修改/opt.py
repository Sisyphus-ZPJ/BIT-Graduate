...
def get_opts():
    ...
    parser.add_argument('--root_dir', type=str,
                        default='./nerf_synthetic/chair',
                        help='root directory of dataset')
    
    parser.add_argument('--exp_name', type=str, default='chair_ori_fine10', help='experiment name')
    ...
    parser.add_argument('--N_importance', type=int, default=10,
