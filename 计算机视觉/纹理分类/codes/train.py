...
def main(args):
    ...
    transform_train = transforms.Compose([# Resize(base_size),
                                          ...
                                          normalize])
    transform_validate = transforms.Compose([# Resize(base_size),
                                             CenterCrop(352),
                                             ToTensor(),
                                             normalize])
    train_dataset = MINCDataset(root=args.data_path, split='train', transform=transform_train)
    ...
    validate_dataset = MINCDataset(root=args.data_path, split='validate', transform=transform_validate)
    validate_dataloader = torch.utils.data.DataLoader(validate_dataset, batch_size=8, shuffle=False, num_workers=4, pin_memory=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, 
                        default='/data/zhangpengjie/zhangpengjie/Workspace/Experiments/Texture/checkpoints/2')
